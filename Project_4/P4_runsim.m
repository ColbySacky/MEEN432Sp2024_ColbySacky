...
open_system('Project_4_Simulink');
set_param('Project_4_Simulink', 'StopTime', num2str(sim_time));


close_system('Project_4_Simulink', 0);

%% Run Simulation %%
out = sim("Project_4_Simulink.slx", "StopTime", "3600");
