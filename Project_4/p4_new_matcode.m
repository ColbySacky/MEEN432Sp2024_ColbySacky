...
SOC = out.SOC.Data; % Assume SOC output variable is named 'SOC' in Simulink model
brake_viol = out.brake.Data; % Assume brake violation output variable is named 'brake' in Simulink model
